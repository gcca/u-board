...
pub fn build(b: *std.Build) void {
    ...
    const uboard_mod = b.addModule("u-board", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "u-board" is the name you will use in your source code to
                // import this module (e.g. `@import("u-board")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "u-board", .module = uboard_mod },
            },
        }),
    });
    exe.linkLibC();
    ...
    const create_user = b.addExecutable(.{
        .name = "u-board-cmd_create-user",
        .root_module = b.createModule(.{
            .root_source_file = b.path("cmd/u-board-cmd_create-user.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    uboard_mod.addImport("zap", zap.module("zap"));
    uboard_mod.addImport("u-board", uboard_mod);
    exe.root_module.addImport("zap", zap.module("zap"));

    create_user.linkLibC();
    create_user.linkSystemLibrary("sqlite3");
    create_user.root_module.addImport("clap", clap.module("clap"));
    create_user.root_module.addImport("u-board", uboard_mod);

    const cmd_datalake_clone = b.addExecutable(.{
        .name = "u-board-cmd_datalake-clone",
        .root_module = b.createModule(.{
            .root_source_file = b.path("cmd/u-board-cmd_datalake-clone.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const cmd_datalake_init = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("cmd/u-board-cmd_datalake-init.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
